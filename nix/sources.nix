...
let
  ...
  # `refs/umbrella/easykubenix/*`. `umbrella mark` publishes them.
  #
  ...
  # `github:Lillecarl/easykubenix`, a release tarball, or a pull request from a
  ...
  umbrellaRef =
    if umbrellaRev != "" then
      ...
      throw ''
        nix/sources.nix: no umbrella to build easykubenix against.
        ...
        nearest landed ancestor of HEAD:
          ...
          ci/walkback.sh https://github.com/nixidae/nixidae easykubenix
